...
const Color yellow = Color.fromRGBO(233, 199, 16, 1.0);
...
class _SplashState extends State<Splash> with TickerProviderStateMixin {
  ...
  Future<void> logIn() async {
    ...
    // if (form.validate()) {
    //   await Provider.of<AuthProvider>(context).login(mobile, password);
    // }
                ...
                new Expanded(
                  child: new FlatButton(
                    ...
                    onPressed: () => {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => Activate(mobile)),
                      )
                    },
                    child: new Container(
                      padding: const EdgeInsets.symmetric(
